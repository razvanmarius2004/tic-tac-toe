...
public class ConnectionUtils {
    private static final String username = "Razvan";
    ...
    static class ReceiveBytesPayloadListener extends PayloadCallback {
        ...
        public void onPayloadReceived(@NonNull String endpointId, Payload payload) {
            ...
            if (payload.getType() == Payload.Type.BYTES) {
                ...
                Toast.makeText(sWeakRef.get(), message, Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public static void SendMessage(Context context, String sendInfo) {
